...
const SOPCard = () => {
  return (
    <div className="course_card mt-0" style={{ backgroundColor: "rgb(243 243 243 / 47%)" }}>
      ...
      <div className="mt-4">
        <h4 style={{fontFamily:"Lato", fontWeight: 700}}>What is Statement of Purpose</h4>
        <p style={{fontFamily:"Lato", fontWeight: 500}} className=" mb-5">
...
crafting a strong SOP that effectively communicates your academic and professional aspirations, ultimately increasing your chances of securing admission to your desired university or program.
      ...
      <div className="mt-4">
        <h4 style={{fontFamily:"Lato", fontWeight: 700}}>Why Statement of Purpose is important</h4>
...
writing a compelling SOP is essential to increase your chances of securing admission to your desired university and fulfilling your academic aspirations abroad.        
      ...
      <div className="mt-4">
        <h4 style={{fontFamily:"Lato", fontWeight: 700}}>Statement of Purpose format</h4>
        <p style={{fontFamily:"Lato", fontWeight: 500}}>
...
revise your statement to ensure clarity, coherence, and conciseness. Finally, seek feedback once more and make any final adjustments before submitting your statement.
      ...
      <div className="mt-4">
        <h4 style={{fontFamily:"Lato", fontWeight: 700}}>What do an college look for an Statement of Purpose</h4>
        <p style={{fontFamily:"Lato", fontWeight: 500}}>
...
unique qualities and experiences, making a compelling case for why you are a strong candidate for admission.        </p>
      ...
      <div className="mt-4">
        <h4 style={{fontFamily:"Lato", fontWeight: 700}}>Tip for writing Statement of Purpose</h4>
        <p style={{fontFamily:"Lato", fontWeight: 500}}>
...
Get feedback: Have someone else read your statement to provide feedback and ensure it effectively conveys your message.        </p>
      ...
      <div className="mt-4">
        <h4 style={{fontFamily:"Lato", fontWeight: 700}}>Statement of Purpose for UG and SOP for PG</h4>
        <p style={{fontFamily:"Lato", fontWeight: 500}}>
...
goals. PG SOPs also often require a stronger focus on research experiences, showcasing the applicant's readiness for advanced study and research in the field. Here are quick details what differs the two:
      ...
      <div className="mt-4">
        <h4 style={{fontFamily:"Lato", fontWeight: 700}}>Common mistake to avoid in SOP</h4>
        <p style={{fontFamily:"Lato", fontWeight: 500}}>
...
10. <strong>Failure to Proofread</strong>: Before submitting your SOP, carefully proofread it to catch any errors or typos. It's also helpful to have someone else review it for feedback.<br/><br/>
      ...
      <div className="mt-4">
        <h4 style={{fontFamily:"Lato", fontWeight: 700}}>Importance of SOP </h4>
        <p style={{fontFamily:"Lato", fontWeight: 500}}>
      ...
      <div className="mt-4">
        <h4 style={{fontFamily:"Lato", fontWeight: 700}}>Word limit of SOP</h4>
        <p style={{fontFamily:"Lato", fontWeight: 500}}>
